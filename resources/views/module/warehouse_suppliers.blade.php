...
<div class="main mt-3" id="main" style="padding-top: 0px;">
    <div class="mb-1 p-3">
        ...
        <span class="mt-0">Dashboard > Warehouse > <span class="text-muted">Supplier & Manufacturer</span></span>
    </div>
    <div class="card p-3">
...
<script>
    ...
    $('#supplierForm').on('submit', function(e) {
        ...
        $.ajax({
            url: "{{ route('warehouse.supplier.add') }}", // Your Laravel route
            type: 'POST',
            data: formData,
    ...
    var table = $('#example').DataTable({
        ...
        "scrollX": true,
        "ajax": {
            url: "{{ url('api/warehouse/supplier') }}",
            headers: {
